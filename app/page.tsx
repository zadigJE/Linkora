...
import LandingSessionRedirect from "../components/LandingSessionRedirect";
import {
  createClient,
...
export default async function Home({
  ...
  return (
    <div className="relative min-h-screen overflow-x-clip px-4 pt-3 sm:px-6 sm:pt-8 lg:px-8">
